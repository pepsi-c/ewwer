...
function getAll(bot, message) {
    const embed = new MessageEmbed()
        .setColor("#000000")
        .setAuthor('Atlantis | Help', bot.user.avatarURL())
...
function getCMD(bot, message, input) {
    ...
    return message.channel.send(embed.setColor("#000000").setDescription(info).setAuthor('Atlantis | Cmd | Help', bot.user.avatarURL()));
}